    ...
    <section className="py-32 relative border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-16">
        ...
        <div className="w-full md:w-1/2">
          <ScrollReveal>
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-tight mb-8">
              No somos una <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-200 to-slate-600">fábrica de software.</span>
            </h2>
            <div className="h-1 w-20 bg-electric rounded-full" />
          </ScrollReveal>
        </div>

        <div className="w-full md:w-1/2 space-y-8">
          <ScrollReveal delay={200}>
            <h3 className="font-display text-2xl text-white font-semibold">Somos su brazo tecnológico.</h3>
